	    ...
	    _createClass(_class, [{
	      ...
	      value: function componentWillMount() {
	        ...
	        if (options.fetchAction) {
	          ...
	          if (cat.fetchMap) {
	            ...
	            var payload = getPayload(this.props, getChildContext(Component.contextTypes, this.context));
	      ...
	      value: function componentDidMount() {
	        ...
	        if (options.action && getPayload) {
	          ...
	          options.action(getPayload(this.props, getChildContext(Component.contextTypes, this.context)));
	        }
	      }
	    }, {
	      ...
	      value: function componentWillReceiveProps(nextProps, nextContext) {
	        ...
	        if (options.action && options.shouldContainerFetch && options.shouldContainerFetch(this.props, nextProps, this.context, nextContext)) {
	          ...
	          options.action(getPayload(nextProps, getChildContext(Component.contextTypes, nextContext)));
	        }
	      }
	    }, {
