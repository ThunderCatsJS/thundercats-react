...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("react"), require("rx"), require("thundercats"));
	else if(typeof define === 'function' && define.amd)
		define(["react", "rx", "thundercats"], factory);
	else if(typeof exports === 'object')
		exports["ThunderCatsReact"] = factory(require("react"), require("rx"), require("thundercats"));
	else
		root["ThunderCatsReact"] = factory(root["React"], root["Rx"], root["ThunderCats"]);
})(this, function(__WEBPACK_EXTERNAL_MODULE_4__, __WEBPACK_EXTERNAL_MODULE_10__, __WEBPACK_EXTERNAL_MODULE_28__) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createContainer = __webpack_require__(13);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactLibCloneWithProps = __webpack_require__(24);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ContextWrapper = __webpack_require__(11);

	var _ContextWrapper2 = _interopRequireDefault(_ContextWrapper);

	var _thundercats = __webpack_require__(28);
	...
	function fetch(fetchMap) {
	  ...
	  .filter(function (store) {
	    ...
	    return _thundercats.waitFor.apply(undefined, _toConsumableArray(arrayOfStores)).firstOrDefault();
	  });
	    ...
	    _createClass(_class, [{
	      ...
	      value: function componentWillMount() {
	        ...
	        if (options.fetchAction) {
	          ...
	          if (cat.fetchMap) {
	            ...
	            var payload = getPayload((0, _objectAssign2['default'])({}, this.state, this.props), getChildContext(Component.contextTypes, this.context));
	      ...
	      value: function componentDidMount() {
	        ...
	        if (options.action) {
	          ...
	          options.action(getPayload((0, _objectAssign2['default'])({}, this.state, this.props), getChildContext(Component.contextTypes, this.context)));
	        }
	      }
	    }, {
	      ...
	      value: function componentWillReceiveProps(nextProps, nextContext) {
	        /* istanbul ignore else */
	        if (options.action && options.shouldContainerFetch && options.shouldContainerFetch((0, _objectAssign2['default'])({}, this.state, this.props), (0, _objectAssign2['default'])({}, this.state, nextProps), this.context, nextContext)) {
	          debug('%s fetching on componentWillReceiveProps', (0, _utils.getName)(this));
	          options.action(getPayload((0, _objectAssign2['default'])({}, this.state, nextProps), getChildContext(Component.contextTypes, nextContext)));
	        }
	      }
	    }, {
